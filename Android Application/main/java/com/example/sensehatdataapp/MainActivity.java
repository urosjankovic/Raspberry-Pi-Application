        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             /*   TextView tv1= (TextView) findViewById(R.id.textView16);
              ...
              TextView tv3= (TextView) findViewById(R.id.textView18);


                tv1.setText("IP address: "+Server_param.globalip);
                tv2.setText("Sample time: "+Integer.toString(Server_param.globalsampletime)+"ms");
                tv3.setText("No. of Samples: "+Integer.toString(Server_param.globalsamples));
                */
